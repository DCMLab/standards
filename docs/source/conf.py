...
html_theme_path = sphinx_bootstrap_theme.get_html_theme_path() # pip install sphinx_bootstrap_theme
html_theme_options = {
    # Navigation bar title. (Default: ``project`` value)
    'navbar_title': "DCML Guidelines",

    # Tab name for entire site. (Default: "Site")
    'navbar_site_name': "Other pages",
...
# html_theme = 'cloud'  # pip install cloud_sptheme
# html_theme_options = {
