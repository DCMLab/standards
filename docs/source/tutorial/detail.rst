...
.. admonition:: Review Solution 3 and spot as many places as possible where the annotations are inconsistent or would require justification
  ...
  Consistencies
    * The reviewer was consistent in the decision to assume a 4/4 harmonic rhythm to a point that, where necessary,
      ...
      following eighth (mm. 3, 5, 6, 8). (Consider, however, the comment on mm. 4 vs. 9 and on m. 7 below.)
    * ``G#`` and ``C#`` have been interpreted as thirds of dominant chords (mm. 2 & 9) except where hindered by a
      pedal note (mm. 1, 2 & 10).
    * ``ii%65`` was consistently added as a possible realization of bass ``D`` + figure ``6`` (however, consider the
  ...
  Inconsistencies
    ...
    * m. 9: ``#viio6`` possible is possible but is inconsistent with mm. 2, 5, 6 & 8 where no chord changes were
  ...
  Justification requested
    ...
    * m. 10: ``iio6 ii%65-iio6``: the alternative reading would result in redundant progression ``iio6 iio6``
