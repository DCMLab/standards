...
# this is a second version of the same regex which allows for parsing an additional
# alternative label separated by a dash: <first>-<second>
allowing_alternatives = r"""
    ^(?P<first>
      (\.?
        ((?P<globalkey>[a-gA-G](b*|\#*))\.)?
        ((?P<localkey>(b*|\#*)(VII|VI|V|IV|III|II|I|vii|vi|v|iv|iii|ii|i))\.)?
